...
<html>
  ...
  <body>
    <div class="container">
      ...
      <form method="post" action="{{url('projeto/edite/'. $projeto['id'])}}">
        @csrf  
        <div class="row">
        ...
        <div class="row">
          ...
          <div class="col-md-4"></div>
            <div class="form-group col-md-4">
              ...
              <input type="text" class="form-control" name="hora" value="{{$projeto->hora}}">
            </div>
          </div>
        ...
        <div class="row">
          <div class="col-md-4"></div>
            <div class="form-group col-md-4">
              ...
              <input type="text" class="form-control" name="data" value="{{$projeto->data}}">
            </div>
          </div>
